...
if (!empty($slug)) {
    ...
    if ($sRow = mysqli_fetch_assoc($slugRes)) {
        $pre_selected_id = $sRow['id'];
    }
}
...
<style>
    ...
    .step-item.active .step-blob {
        border-color: var(--udhhar-teal);
        color: var(--udhhar-teal);
        transform: scale(1.1);
        box-shadow: 0 10px 20px rgba(0, 212, 170, 0.2);
    }

    .step-item.completed .step-blob {
        background: var(--udhhar-teal);
        border-color: var(--udhhar-teal);
        color: white;
    }
    ...
    .apply-glass-card {
        ...
        box-shadow: 0 30px 60px rgba(11, 8, 27, 0.1);
    }
    ...
    .section-title {
        font-weight: 800;
        color: var(--udhhar-navy);
        border-left: 4px solid var(--udhhar-teal);
        padding-left: 15px;
        margin-bottom: 25px;
    }
    ...
    .consent-wrapper {
        background: #f8fafc;
        border-radius: 20px;
        border: 1px solid var(--udhhar-border);
    }
            ...
            <?php if (!$is_logged_in): ?>
                <div class="text-center">
                    <div class="login-banner">
                        ...
                        <a href="login.php?redirect=<?= urlencode($return_path) ?>"
                            class="ms-2 fw-bold text-decoration-none" style="color: var(--udhhar-navy);">
                    ...
                    <div class="p-4 p-md-5">
                            ...
                            <div class="tab" id="tab0">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6"><label class="form-label">Full Name</label><input type="text"
                                            name="full_name" class="form-control" placeholder="Enter full name" required>
                                    </div>
                                    <div class="col-md-6"><label class="form-label">Mobile</label><input type="text"
                                            name="phone" class="form-control" placeholder="Enter mobile number" required
                                            maxlength="10" inputmode="numeric" pattern="[6-9]{1}[0-9]{9}"
                                            title="Enter valid 10-digit mobile number starting with 6-9"></div>
                                    <div class="col-md-6"><label class="form-label">Email</label><input type="email"
                                            name="email" class="form-control" placeholder="Enter email address" required>
                                    </div>
                                    <?php if ($is_register_only): ?>
                                        <div class="col-md-6"><label class="form-label">Password</label><input type="password"
                                                ...
                                                minlength="8"></div>
                                    <?php endif; ?>
                                    <div class="col-md-12"><label class="form-label">Birth Date</label><input type="date"
                                            name="birth_date" id="birth_date" class="form-control" required></div>
                                </div>
                            </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="pan_number" id="pan_number" class="form-control"
                                            style="text-transform:uppercase" required pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}">
                                    ...
                                    <div class="col-md-4"><label class="form-label">Monthly Income</label><input
                                            type="number" name="monthly_income" class="form-control" required></div>
                                    ...
                                    <div class="col-md-4"><label class="form-label">State</label><input type="text"
                                            name="state" class="form-control" required></div>
                                    <div class="col-md-4"><label class="form-label">City</label><input type="text"
                                            name="city" class="form-control" required></div>
                                    <div class="col-md-4"><label class="form-label">Pin Code</label><input type="text"
                                            name="pin_code" class="form-control" required maxlength="6" pattern="[0-9]{6}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="reference1_name" class="form-control"
                                                placeholder="Enter reference 1 name" required
                                                pattern="[A-Za-z][A-Za-z\s]{1,}" title="Enter a valid name">
                                            <input type="text" name="reference1_phone" class="form-control"
                                                placeholder="Enter reference 1 phone" required maxlength="10"
                                                pattern="[6-9]{1}[0-9]{9}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="reference2_name" class="form-control"
                                                placeholder="Enter reference 2 name" required
                                                pattern="[A-Za-z][A-Za-z\s]{1,}" title="Enter a valid name">
                                            <input type="text" name="reference2_phone" class="form-control"
                                                placeholder="Enter reference 2 phone" required maxlength="10"
                                                pattern="[6-9]{1}[0-9]{9}">
                                        </div>
                                        <small class="text-muted d-block mt-1">Note: Reference 1 and Reference 2 details
                                            should not be same.</small>
                                        <small id="referenceDupError" class="text-danger d-none mt-1 d-block">Reference 1
                                            and Reference 2 details must not be same.</small>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        ...
                                        <select name="service_id" id="service_select" class="form-select"
                                            onchange="fetchDocs(this.value)" required>
                                    ...
                                    <div class="col-md-6"><label class="form-label">Amount Required (₹)</label><input
                                            type="number" name="requested_amount" class="form-control" required></div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="consent-wrapper p-4">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label small fw-bold">I agree to <a href="terms.php"
                                                        target="_blank" rel="noopener">Terms & Conditions</a>.</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="c3"
                                                    onchange="toggleSubmit()">
                                                <label class="form-check-label small fw-bold">I accept the <a
                                                        href="privacy.php" target="_blank" rel="noopener">Privacy
                                                        Policy</a>.</label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="d-flex justify-content-between mt-5 pt-4 border-top">
                            <button type="button" class="btn btn-light" id="prevBtn"
                                onclick="changeTab(-1)">Back</button>
                            <button type="button" class="btn btn-dark px-5 py-3 fw-bold" id="nextBtn"
                                onclick="changeTab(1)" style="border-radius:15px; background:var(--udhhar-navy)">Next
                                Step</button>
                        </div>
                    </div>
                </form>
