    ...
    <div class="container py-5" style="position: relative; padding-top: 5rem !important;">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-lg-start text-center mb-3 mb-lg-0">
                ...
                <a href="#" class="d-inline-block app-badge-link">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg"
                        alt="Get it on Google Play" class="app-badge" style="height: 40px;">
                </a>
            </div>
            ...
            <div class="col-lg-4 text-lg-end text-center">
                <a href="terms.php" class="footer-top-link text-decoration-none fw-semibold me-3"
                    style="transition: color 0.3s ease;">Terms</a>
                <span style="color: #334155;">|</span>
                <a href="privacy.php" class="footer-top-link text-decoration-none fw-semibold ms-3"
                    style="transition: color 0.3s ease;">Privacy</a>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                ...
                <ul class="list-unstyled footer-links-list">
                    <li class="mb-2"><a href="index.php" class="footer-quick-link text-decoration-none"><i
                                class="fas fa-angle-right me-2"></i>Home</a></li>
                    <li class="mb-2"><a href="about.php" class="footer-quick-link text-decoration-none"><i
                                class="fas fa-angle-right me-2"></i>About </a></li>
                    <li class="mb-2"><a href="all_services.php" class="footer-quick-link text-decoration-none"><i
                                class="fas fa-angle-right me-2"></i>Our Services</a></li>
                    <li class="mb-2"><a href="career.php" class="footer-quick-link text-decoration-none"><i
                                class="fas fa-angle-right me-2"></i>Careers</a></li>
                    <li class="mb-2"><a href="contact.php" class="footer-quick-link text-decoration-none"><i
                                class="fas fa-angle-right me-2"></i>Contact Us</a></li>
                    <li class="mb-2"><a href="terms.php" class="footer-quick-link text-decoration-none"><i
                                class="fas fa-angle-right me-2"></i>Terms & Conditions</a></li>
                    <li class="mb-2"><a href="privacy.php" class="footer-quick-link text-decoration-none"><i
            ...
            <div class="col-lg-6 col-md-12">
                <div class="map-container"
                    style="border-radius: 15px; overflow: hidden; border: 1px solid rgba(255,255,255,0.1); height: 200px;">
