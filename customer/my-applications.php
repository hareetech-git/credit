                                ...
                                <div class="card-modern p-4">
                                    ...
                                    <div class="border-top pt-3 mt-3">
                                        <div class="d-flex justify-content-between small text-muted mb-2">
                                            ...
                                            <span
                                                class="text-dark fw-semibold"><?= date('d M Y', strtotime($row['created_at'])) ?></span>
                                        </div>
                                        <div class="d-flex justify-content-between small text-muted mb-3">
                                            <span>Tenure:</span>
                                            <span class="text-dark fw-semibold"><?= $row['tenure_years'] ?> Years</span>
                                        </div>
                                        <a href="view-application-detail.php?id=<?= $row['id'] ?>"
                                            class="btn btn-outline-dark btn-sm w-100 fw-bold rounded-pill mb-2">View Full
                                            Status</a>
                                        <a href="enquiry_add.php?loan_type=<?= (int) $row['sub_category_id'] ?>"
                                            class="btn btn-dark btn-sm w-100 fw-bold rounded-pill">Raise Enquiry</a>
                                    </div>
                                </div>
                            </div>
                        <?php endwhile; ?>
