...
$query = "SELECT * FROM enquiries WHERE customer_id = $customer_id";
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold text-dark mb-1">My Enquiries</h2>
                    <div class="text-muted small">Track conversations with staff/admin</div>
                </div>
            </div>
                    ...
                    <form method="GET" class="row g-3 align-items-end">
                        <div class="col-md-7">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" name="search" class="form-control border-start-0" placeholder="Search by loan type..." value="<?= htmlspecialchars($search_query) ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
