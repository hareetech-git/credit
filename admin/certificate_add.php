            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="mb-4 text-center text-md-start">
                        <h2 class="fw-bold text-dark mb-1">Add New Certificate</h2>
                        <p class="text-muted small">Add certificates and awards to display on the website.</p>
                    </div>

                    <div class="card card-modern">
                        <div class="card-body p-4 p-md-5">

                            <form method="POST" action="db/insert/certificate_insert.php" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text"
                                               name="name"
                                               class="form-control"
                                               placeholder="e.g. G India Credit"
                                               required>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="file" 
                                               ...
                                               required>
                                        <small class="text-muted">Recommended: Image with aspect ratio 4:3 or 1:1</small>
