            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="mb-4 text-center text-md-start">
                        <h2 class="fw-bold text-dark mb-1">Add New Brand</h2>
                        <p class="text-muted small">Add trusted brands that partner with us.</p>
                    </div>

                    <div class="card card-modern">
                        <div class="card-body p-4 p-md-5">

                            <form method="POST" action="db/insert/brand_insert.php" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text"
                                               name="brand_name"
                                               class="form-control"
                                               placeholder="e.g. IDFC FIRST Bank"
                                               required>
                                    </div>

                                    <div class="col-md-6 mb-4">
                                        <label class="form-label">Brand Logo/Image <span class="text-danger">*</span></label>
                                        <input type="file" 
                                               name="brand_img" 
                                               class="form-control" 
                                               accept="image/*"
                                    ...
                                    <div class="col-12 mt-2 pt-4 border-top d-flex align-items-center">
                                        ...
                                        <a href="brands.php" class="btn-cancel ms-4">
                                            Cancel
                                        </a>
                                    </div>
                                </div>
