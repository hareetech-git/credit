                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end gap-2">
                                                    <a href="customer_view.php?id=<?= $row['id'] ?>" class="btn-action btn-view" title="View Profile">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="customer_add.php?id=<?= $row['id'] ?>" class="btn-action btn-edit" title="Edit Customer">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="db/delete/customer_delete.php?action=delete&id=<?= $row['id'] ?>" 
