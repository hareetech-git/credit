...
if (!hasAccess($conn, 'faq_create') && !hasAccess($conn, 'faq_delete')) {
    header('Location: dashboard.php?err=FAQ permission required');
    exit();
}
        ...
        <div class="container-fluid pt-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted small mb-0">Manage FAQs shown on the homepage.</p>
                </div>
            </div>
            ...
            <?php if (hasAccess($conn, 'faq_create')): ?>
                    ...
                    <table class="table table-hover align-middle">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th>Created By</th>
                                <th>Created At</th>
                                <?php if (hasAccess($conn, 'faq_delete')): ?>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="<?= hasAccess($conn, 'faq_delete') ? '6' : '5' ?>" class="text-center text-muted">No FAQs found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
