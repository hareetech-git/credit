            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <form method="POST" action="db/enquiry_status.php">
                        ...
                        <button class="btn btn-sm btn-outline-success" type="submit" <?= ($is_closed_or_converted || !$can_change_status) ? 'disabled' : '' ?>>Mark Converted</button>
                    </form>
                    <form method="POST" action="db/enquiry_status.php">
                        <input type="hidden" name="enquiry_id" value="<?= $enquiry_id ?>">
                        <input type="hidden" name="action" value="close">
                        <button class="btn btn-sm btn-outline-secondary" type="submit" <?= ($is_closed_or_converted || !$can_change_status) ? 'disabled' : '' ?>>Close Enquiry</button>
                    </form>
                </div>
            </div>
