        ...
        <div class="container-fluid ">
            ...
            <div class="d-flex justify-content-between align-items-end mb-4">
                <div>
                    ...
                    <h2 class="fw-bold text-dark mb-0">Processing Enquiry</h2>
                </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="card-modern p-4 text-center">
                        ...
                        <div class="d-flex gap-2 justify-content-center border-top pt-3">
                            <form method="POST" action="db/enquiry_status.php" class="flex-fill">
                                ...
                                <button class="btn btn-sm btn-outline-success w-100 fw-bold rounded-pill" type="submit" <?= ($is_closed_or_converted || !$can_change_status) ? 'disabled' : '' ?>>Convert</button>
                            </form>
                            <form method="POST" action="db/enquiry_status.php" class="flex-fill">
                                <input type="hidden" name="enquiry_id" value="<?= $enquiry_id ?>">
                                <input type="hidden" name="action" value="close">
                                <button class="btn btn-sm btn-outline-secondary w-100 fw-bold rounded-pill" type="submit" <?= ($is_closed_or_converted || !$can_change_status) ? 'disabled' : '' ?>>Close</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card-modern p-4">
                        <h6 class="fw-bold text-uppercase small text-muted mb-3">Staff Owner</h6>
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="text-muted x-small"><?= htmlspecialchars($enquiry['assigned_staff_email'] ?: 'Managed by you') ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="card-modern">
                        ...
                        <div class="p-3 bg-light">
                            <?php if ($is_closed_or_converted): ?>
                                <div class="text-center text-muted small py-2"><i class="fas fa-lock me-1"></i> Enquiry is locked</div>
                            <?php else: ?>
                                <form method="POST" action="db/enquiry_message.php">
                                    <input type="hidden" name="enquiry_id" value="<?= $enquiry_id ?>">
                                    <div class="input-group">
                                        <textarea name="message" class="form-control" rows="2" placeholder="Write a reply to the customer..." required style="border-radius: 12px;"></textarea>
                    ...
                    <div class="card-modern">
                        ...
                        <div class="p-4">
                            <?php if (empty($notes)): ?>
                                <p class="text-muted small italic">No internal notes added.</p>
                            <?php else: ?>
                            ...
                            <form method="POST" action="db/enquiry_note.php" class="mt-4 pt-3 border-top">
                                <input type="hidden" name="enquiry_id" value="<?= $enquiry_id ?>">
                                <label class="form-label small fw-bold">Add Team Note</label>
