...
function sortLink($col, $label, $current_col, $current_order, $next_order) {
    ...
    return '<a href="?sort='.$col.'&order='.$next_order.'" class="sort-link text-decoration-none">' . $label . $icon . '</a>';
}
?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-modern mb-0">
                            <thead>
                                <tr>
                                    <th width="60">Sr.</th>
                                    <th><?= sortLink('c.full_name', 'Customer', $sort_column, $sort_order, $next_order) ?></th>
                                    <th>Service</th>
                                    <th><?= sortLink('l.requested_amount', 'Amount', $sort_column, $sort_order, $next_order) ?></th>
                                    <th>Interest</th>
                                    <th>Status</th>
                                    <th><?= sortLink('l.created_at', 'Date Applied', $sort_column, $sort_order, $next_order) ?></th>
